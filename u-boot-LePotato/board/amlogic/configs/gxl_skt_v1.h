...
#define CONFIG_IR_REMOTE_USE_PROTOCOL 4					// 0:nec  1:duokan  2:Toshiba 3:rca 4:rc5 5:software decode
#define CONFIG_IR_REMOTE_USE_PROTOCOL_SOFTWARE_DECODE 5	// 0:nec  1:duokan  2:Toshiba 3:rca 4:rc5 5:software decode
