...
{
    RF_ADR_LDO_REGISTER,
    RF_ADR_TX_FE_REGISTER,
    RF_ADR_RX_FE_REGISTER_1,
    RF_ADR_RX_FE_GAIN_DECODER_REGISTER_1,
    RF_ADR_RX_FE_GAIN_DECODER_REGISTER_2,
    RF_ADR_RX_TX_FSM_REGISTER,
    RF_ADR_SYN_VCO_LOBF,
    RF_ADR_SYN_KVCO_XO_FINE_TUNE_CBANK,
    RF_SET_IDX_PMU_2,
    RF_SET_IDX_MAX,
};
...
{
    SMAC_REG_WRITE(sh, ADR_SX_ENABLE_REGISTER, 0);
    ...
    SMAC_REG_WRITE(sh, ADR_SX_ENABLE_REGISTER, 0x0003E07C);
    msleep(10);
}
 ...
 u32 regval;
    ...
    switch (sh->cfg.chip_identity) {
        ...
        case SSV6051Z:
            ...
            if (rf_tbl[RF_ADR_LDO_REGISTER].address == ADR_LDO_REGISTER){
                rf_tbl[RF_ADR_LDO_REGISTER].data = 0x004D561C;
            } else
                goto Wrong_index;
            if (rf_tbl[RF_ADR_TX_FE_REGISTER].address == ADR_TX_FE_REGISTER){
                rf_tbl[RF_ADR_TX_FE_REGISTER].data = 0x3D9E84FE;
            } else
                goto Wrong_index;
            if (rf_tbl[RF_ADR_RX_FE_REGISTER_1].address == ADR_RX_FE_REGISTER_1){
                rf_tbl[RF_ADR_RX_FE_REGISTER_1].data = 0x00457D79;
            } else
                goto Wrong_index;
            if (rf_tbl[RF_ADR_RX_FE_GAIN_DECODER_REGISTER_1].address == ADR_RX_FE_GAIN_DECODER_REGISTER_1){
                rf_tbl[RF_ADR_RX_FE_GAIN_DECODER_REGISTER_1].data = 0x000103EB;
            } else
                goto Wrong_index;
            if (rf_tbl[RF_ADR_RX_FE_GAIN_DECODER_REGISTER_2].address == ADR_RX_FE_GAIN_DECODER_REGISTER_2){
                rf_tbl[RF_ADR_RX_FE_GAIN_DECODER_REGISTER_2].data = 0x000103EA;
            } else
                goto Wrong_index;
            if (rf_tbl[RF_ADR_RX_TX_FSM_REGISTER].address == ADR_RX_TX_FSM_REGISTER){
                rf_tbl[RF_ADR_RX_TX_FSM_REGISTER].data = 0x00062CA8;
            } else
                goto Wrong_index;
            if (rf_tbl[RF_ADR_SYN_VCO_LOBF].address == ADR_SYN_VCO_LOBF){
                rf_tbl[RF_ADR_SYN_VCO_LOBF].data = 0xFCCCCF27;
        ...
        case SSV6051P:
            ...
            if (rf_tbl[RF_ADR_LDO_REGISTER].address == ADR_LDO_REGISTER){
                rf_tbl[RF_ADR_LDO_REGISTER].data = 0x008B7C1C;
            } else
                goto Wrong_index;
            if (rf_tbl[RF_ADR_TX_FE_REGISTER].address == ADR_TX_FE_REGISTER){
                rf_tbl[RF_ADR_TX_FE_REGISTER].data = 0x3D7E84FE;
            } else
                goto Wrong_index;
            if (rf_tbl[RF_ADR_RX_FE_REGISTER_1].address == ADR_RX_FE_REGISTER_1){
                rf_tbl[RF_ADR_RX_FE_REGISTER_1].data = 0x01457D79;
            ...
            if (rf_tbl[RF_ADR_RX_TX_FSM_REGISTER].address == ADR_RX_TX_FSM_REGISTER){
                ...
                goto Wrong_index;
            if (rf_tbl[RF_ADR_SYN_VCO_LOBF].address == ADR_SYN_VCO_LOBF){
                rf_tbl[RF_ADR_SYN_VCO_LOBF].data = 0xFCCCCC27;
            } else
                goto Wrong_index;
            if (rf_tbl[RF_ADR_SYN_KVCO_XO_FINE_TUNE_CBANK].address == ADR_SYN_KVCO_XO_FINE_TUNE_CBANK){
                rf_tbl[RF_ADR_SYN_KVCO_XO_FINE_TUNE_CBANK].data = 0x0047C000;
