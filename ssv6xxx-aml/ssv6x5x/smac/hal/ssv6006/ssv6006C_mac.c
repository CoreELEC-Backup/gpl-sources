...
static void ssv6006c_cmd_hwinfo(struct ssv_hw *sh, int argc, char *argv[])
{
    ...
    if (!strcmp(argv[1], "mac")) {
        if ((argc == 3) && (!strcmp(argv[2], "peer"))) {
            ...
            snprintf_res(cmd_data, "hwmsg mac [peer|stat|scrt|beacon|txq|edca|tx|tx2phy|tx2ptc|fixrate|txfsm|txifs|txbase|hci]\n\n");
        }
        ...
        snprintf_res(cmd_data, "hwmsg [hwmac|phy]\n\n");
    }
    return;
}
