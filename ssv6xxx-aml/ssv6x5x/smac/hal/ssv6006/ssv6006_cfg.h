...
#define SSV6006_PAGE_TX_THRESHOLD (SSV6006_TOTAL_PAGE*3/4 - SSV6006_RESERVED_USB_PAGE)
#define SSV6006_PAGE_RX_THRESHOLD (SSV6006_TOTAL_PAGE - (SSV6006_PAGE_TX_THRESHOLD + SSV6006_RESERVED_USB_PAGE + SSV6006_RESERVED_SEC_PAGE))
